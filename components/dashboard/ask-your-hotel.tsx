          ...
          <aside className="fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col border-l border-border bg-background shadow-xl">
            <header className="flex items-center justify-between border-b border-border px-5 py-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">Ask your hotel</span>
              </div>
                  ...
                  >
                    ...
                    {m.draftId ? (
                      <Link
                        ...
                        onClick={close}
                        className="rounded-lg border border-primary/30 bg-accent px-3 py-2 text-xs font-medium text-primary"
                      >
            ...
            <div className="flex items-end gap-2 border-t border-border p-4">
              <textarea
                ...
                className="max-h-32 flex-1 resize-none rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              />
              <Button
                size="icon"
                onClick={() => send(input)}
